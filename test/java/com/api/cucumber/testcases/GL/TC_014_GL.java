...
public class TC_014_GL extends ProjMethods {
	...
	public void rateGLLob(@Transform(ExcelDataToDataTable.class) DataTable table) throws Throwable
	{
		...
		lobPage		
		.selGeneralAggregate()
		.selLossFreeYears(data.get(5).get(2).toString())
		.selLossRatedPolicy(data.get(5).get(3).toString())
		.clickNext()
		.selExtnOptions(data.get(5).get(4).toString())
		.clickNextBttn()
		.enterClassCodeSLT(data.get(5).get(5).toString())
		.enterPremiumBasis(data.get(5).get(6).toString())
		.clickLocationOverrides()
		.enterBaseRate(data.get(5).get(7).toString())
		.enterDocumentation(data.get(5).get(1).toString())
		.enterBaseRte(data.get(5).get(7).toString())
		.enterDocumentations(data.get(5).get(1).toString())
	...
	@And("Entering GL LOB Details for Other Location \"([^\"]*)\"$")
	public void enterGLLobDetails(@Transform(ExcelDataToDataTable.class) DataTable table) throws Throwable
	{
		List<List<String>> data = table.raw();
